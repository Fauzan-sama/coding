...
int main()
{
	...
	do //biar klo inputan invalid tetep looping di menu itu
	{
		...
		printf("Opsi:\n[1]Mulai\n[2]Bantuan\n*Disarankan untuk memilih menu bantuan terlebih dahulu\nPilihan Anda: ");
		scanf("%d",&menuawal);
			...
			if (pilihbunga==1)
			{
				...
				switch(pilihvariabel)
				{
					case 1://saldo akhir bunga tunggal
						...
						printf("Saldo akhir Anda adalah %.3f",saldoakhir);
						break;
					...
					case 2://saldo awal bunga tunggal
						...
						printf("Saldo awal Anda adalah %.3f",saldoawal);
						break;
					...
					case 3://masa pinjam/simpan bunga tunggal
						...
						printf("Masa pinjam/simpan Anda adalah %.3f",masa);
						break;
					...
					case 4://suku bunga bunga tunggal
						...
						printf("Suku bunga bank adalah %.3f",sukubunga);
						break;
